        ...
        <Dialog.Content className="fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 max-h-[85vh] w-[90vw] max-w-3xl rounded-lg bg-white p-6 shadow-xl z-50 overflow-y-auto data-[state=open]:animate-contentShow">
          ...
          <div className="mt-6 flex justify-end">
            <Dialog.Close asChild>
              <button className="inline-flex items-center justify-center px-4 py-2 font-medium rounded-md bg-indigo-600 text-white hover:bg-indigo-700 focus:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500 focus-visible:ring-offset-2">
                Entendido
              </button>
            </Dialog.Close>
          </div>
          ...
          <Dialog.Close asChild>
            <button
              className="absolute top-4 right-4 inline-flex items-center justify-center w-8 h-8 rounded-full text-gray-500 hover:text-gray-700 focus:outline-none"
              aria-label="Cerrar"
            >
              <svg
                width="15"
